 ...
 */
class Custom_Singlepagecheckout_Block_Singlepagecheckout_Giftmessage_Inline extends Mage_Core_Block_Template
{
    ...
    {
        parent::_construct();
        $this->setTemplate('singlepagecheckout/singlepagecheckout/giftmessage/inline.phtml');
    }
