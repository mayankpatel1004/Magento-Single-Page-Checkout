 ...
 */
class Custom_Singlepagecheckout_Model_Service_Quote extends Mage_Sales_Model_Service_Quote
{
    /**
     * Quote object
     *
    ...
    protected function _validate()
    {
        ...
        if (!$this->getQuote()->isVirtual()) {
			...
			$addressValidation = Mage::getModel('singlepagecheckout/onepage')->validateAddress($address);
		...
		$addressValidation = Mage::getModel('singlepagecheckout/onepage')->validateAddress($billingAddress);
        if ($addressValidation !== true) {
            Mage::throwException(
